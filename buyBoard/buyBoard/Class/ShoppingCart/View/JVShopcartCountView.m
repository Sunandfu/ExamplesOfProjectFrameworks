...
- (UIButton *)decreaseButton {
    if(_decreaseButton == nil) {
        ...
        [_decreaseButton setImage:[UIImage imageNamed:@"product_detail_sub_normal"] forState:UIControlStateNormal];
        [_decreaseButton setImage:[UIImage imageNamed:@"product_detail_sub_no"] forState:UIControlStateDisabled];
...
- (UIButton *)increaseButton
{
    if(_increaseButton == nil)
    {
        ...
        [_increaseButton setImage:[UIImage imageNamed:@"product_detail_add_normal"] forState:UIControlStateNormal];
