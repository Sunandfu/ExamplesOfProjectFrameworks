...
#define kHorizontalMenuViewInitialPageControlDotSize CGSizeMake(6, 1)
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.menuIcon.layer.masksToBounds = YES;
        self.menuIcon.layer.cornerRadius = self.contentView.kaf_height/2.0;
...
@interface FMHorizontalMenuView ()<UICollectionViewDelegate,UICollectionViewDataSource,FMHorizontalMenuViewDelegate,EllipsePageControlDelegate>
...
- (FMHorizontalMenuViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.menuIcon.layer.masksToBounds = YES;
    cell.menuIcon.layer.cornerRadius = 45/2.0;
