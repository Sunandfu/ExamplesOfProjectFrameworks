...
- (void)configureShopcartBottomViewWithTotalPrice:(float)totalPrice totalCount:(NSInteger)totalCount isAllselected:(BOOL)isAllSelected {
    ...
    [self.settleButton setTitle:[NSString stringWithFormat:@"立即购买(%ld)", totalCount] forState:UIControlStateNormal];
    ...
    if (self.settleButton.isEnabled) {
        [self.settleButton setBackgroundColor:THEME_COLOR];
...
- (void)renderWithTotalPrice:(NSString *)totalPrice {
    ...
    [attributedString addAttributes:@{NSForegroundColorAttributeName:[UIColor colorWithRed:255/255.0 green:0/255.0 blue:0/255.0 alpha:1],NSFontAttributeName:[UIFont systemFontOfSize:16 weight:UIFontWeightBold]} range:[self.totalPriceLable.text rangeOfString:totalPrice]];
...
- (UIButton *)allSelectButton {
    if (_allSelectButton == nil){
        ...
        [_allSelectButton setTitleColor:[UIColor colorWithRed:128/255.0 green:130/255.0 blue:132/255.0 alpha:1] forState:UIControlStateNormal];
...
- (UILabel *)totalPriceLable {
    if (_totalPriceLable == nil){
        ...
        _totalPriceLable.textColor = [UIColor colorWithRed:128/255.0 green:130/255.0 blue:132/255.0 alpha:1];
...
- (UIButton *)settleButton {
    if (_settleButton == nil){
        ...
        [_settleButton setTitle:@"立即购买(0)" forState:UIControlStateNormal];
