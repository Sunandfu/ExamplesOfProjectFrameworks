...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (productArray.count > indexPath.row) {
        ...
        NSString *productName = [NSString stringWithFormat:@"马六甲生态板新款预售%@%@%@", brandModel.brandName, productModel.productStyle, productModel.productType];
        NSString *productSize = [NSString stringWithFormat:@"暖白 W:%ld H:%ld D:%ld 进口马六甲", productModel.specWidth, productModel.specHeight, productModel.specLength];
