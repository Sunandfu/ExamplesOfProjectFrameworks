...
NSString * const SFCollectionID = @"SDCycleScrollViewCell";
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[SDCollectionViewCell class] forCellWithReuseIdentifier:SFCollectionID];
...
- (void)setDelegate:(id<SDCycleScrollViewDelegate>)delegate
{
    ...
    if ([self.delegate respondsToSelector:@selector(customCollectionViewCellClassForCycleScrollView:)] && [self.delegate customCollectionViewCellClassForCycleScrollView:self]) {
        [self.mainView registerClass:[self.delegate customCollectionViewCellClassForCycleScrollView:self] forCellWithReuseIdentifier:[self.delegate cellIdentifierForCycleScrollView:self]];
        ...
        [self.mainView registerNib:[self.delegate customCollectionViewCellNibForCycleScrollView:self] forCellWithReuseIdentifier:[self.delegate cellIdentifierForCycleScrollView:self]];
    }
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.delegate respondsToSelector:@selector(setupCustomCell:forIndex:cycleScrollView:)] &&
        [self.delegate respondsToSelector:@selector(cellIdentifierForCycleScrollView:)] &&
        [self.delegate customCollectionViewCellNibForCycleScrollView:self]) {
        SDCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:[self.delegate cellIdentifierForCycleScrollView:self] forIndexPath:indexPath];
    ...
    SDCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:SFCollectionID forIndexPath:indexPath];
